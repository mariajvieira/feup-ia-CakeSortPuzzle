...
class GameView:
    ...
    def __init__(self, screen, game_state, game_controller=None):
        ...
        self.colors = {
            ...
            'plate': (255, 240, 245),    
            # Cores para os diferentes tipos de fatias 
            'slice_1': (255, 20, 147),     # Rosa 
            'slice_2': (255, 165, 0),      # Laranja
            'slice_3': (50, 205, 50),      # Verde
            'slice_4': (30, 144, 255),     # Azul
            'slice_5': (255, 215, 0),      # Ouro
            'slice_6': (138, 43, 226),     # Violeta
            'slice_7': (220, 20, 60),      # Vermelho 
        ...
        if plate:
            ...
            for i, slice_type in enumerate(reorganized_plate):
                if slice_type is not None:
                    ...
                    start_angle = i * 45 + animation_offset  
